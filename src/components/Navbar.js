...
const Navbar = () => {
  ...
  return (
    <div
      className={
        "w-full min-h-[50px] flex justify-between items-center absolute z-10 text-white bg-gray-700/80"
      }
    >
      ...
      */}
      ...
      <div className="sm:hidden z-10">
        <FaBars onClick={haddleNav} size={20} className="mr-4 cursor-pointer" />
      </div>
      {/* mobile menu */}
      <div
        onClick={haddleNav}
